...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    List<PhotoDetails> myTicketsList;
    Context context;
    ...
    public PhotoAdapter(List<PhotoDetails> myTicketsList, Context context, RecordEditFragment.OpenIntentFromAdapter opent, boolean keyFromAdapter){
        this.myTicketsList=myTicketsList;
        this.context=context;
        openActiv=opent;
