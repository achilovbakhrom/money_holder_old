...
public CreditDetials(String credit_name, int icon_ID, Calendar take_time, double procent, double procent_interval,
                                          long period_time, long period_time_tip, long myCredit_id, double value_of_credit,
                                          double value_of_credit_with_procent, String currencyId, boolean key_for_include,
